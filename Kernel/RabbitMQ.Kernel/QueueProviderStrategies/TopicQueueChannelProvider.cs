...
{
    public class TopicQueueChannelProvider<TQueueMessage> : QueueChannelProviderBase<TQueueMessage>, IQueueChannelProvider<TQueueMessage> where TQueueMessage : IQueueMessage
    {
        private string _routingkey;

        public TopicQueueChannelProvider(IChannelProvider channelProvider) : base(channelProvider)
        {
        ...
        public override void DeclareQueueAndDeadLetter(string _queueName = null)
        {
            ...
            base._channel.ExchangeDeclare(exchange: deadLetterQueueName, type: ExchangeType.Topic);
            ...
            base._channel.QueueBind(queue: deadLetterQueueName, exchange: deadLetterQueueName, routingKey: _routingkey, null);
            ...
            base._channel.ExchangeDeclare(exchange: _queueName, type: ExchangeType.Topic);

            base._channel.QueueDeclare(queue: _queueName, durable: true, exclusive: false, autoDelete: false, arguments: queueArgs);

            base._channel.QueueBind(queue: _queueName, exchange: _queueName, routingKey: _routingkey);
        }
